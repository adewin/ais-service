...
class AggregationTargetStrategyTest {
  ...
  private val ANNUAL_2000_PATH: String =
    "sqlFilename=sqlFile/resample=resampleval/type=annual/year=2000/sqlFile-1km-res-resampleval-annual-2000.tif"
  private val WINTER_1999_PATH: String =
    "sqlFilename=sqlFile/resample=resampleval/type=seasonal/year=1999/season=winter/sqlFile-1km-res-resampleval-winter-1999.tif"
  private val SPRING_PATH: String =
    "sqlFilename=sqlFile/resample=resampleval/type=seasonal/year=2000/season=spring/sqlFile-1km-res-resampleval-spring-2000.tif"
  private val SUMMER_PATH: String =
    "sqlFilename=sqlFile/resample=resampleval/type=seasonal/year=2000/season=summer/sqlFile-1km-res-resampleval-summer-2000.tif"
  private val AUTUMN_PATH: String =
    "sqlFilename=sqlFile/resample=resampleval/type=seasonal/year=2000/season=autumn/sqlFile-1km-res-resampleval-autumn-2000.tif"
  private val WINTER_2000_PATH: String =
    "sqlFilename=sqlFile/resample=resampleval/type=seasonal/year=2000/season=winter/sqlFile-1km-res-resampleval-winter-2000.tif"
