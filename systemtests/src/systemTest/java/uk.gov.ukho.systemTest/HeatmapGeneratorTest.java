...
public class HeatmapGeneratorTest {
    ...
    private final String testFebSqlFileName = "";
    ...
    public void whenMonthlySqlFilesAreIngestedThenSeasonalHeatmapProduced() {
        ...
        uploadObject("test.sql", s3Client);
//        uploadObject(testJanSqlFileName, s3Client);
//        uploadObject(testFebSqlFileName, s3Client);

        downloadObject(bucketName, "interpolation=18hr-100km/unfiltered-18hr-100km-Feb-2019.tif");


    }

    //Optional: General assertions from reading tiff
    ...
    private void downloadObject(final String s3BucketName, final String keyName) {
        ...
        //Need to add timeout or it runs forever!
